...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CircleUser.joined'
        db.delete_column('social_circleuser', 'joined')

        # Adding field 'CircleUser.created'
        db.add_column('social_circleuser', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2012, 12, 3, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'CircleUser.joined'
        db.add_column('social_circleuser', 'joined',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Deleting field 'CircleUser.created'
        db.delete_column('social_circleuser', 'created')
