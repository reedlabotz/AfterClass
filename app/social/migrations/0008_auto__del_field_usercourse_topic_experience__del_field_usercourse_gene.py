...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UserCourse.topic_experience'
        db.delete_column('social_usercourse', 'topic_experience')

        # Deleting field 'UserCourse.general_experience'
        db.delete_column('social_usercourse', 'general_experience')


    def backwards(self, orm):
        # Adding field 'UserCourse.topic_experience'
        db.add_column('social_usercourse', 'topic_experience',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=1),
                      keep_default=False)

        # Adding field 'UserCourse.general_experience'
        db.add_column('social_usercourse', 'general_experience',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=1),
                      keep_default=False)
