...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CircleUser.video'
        db.add_column('social_circleuser', 'video',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'CircleUser.last_video'
        db.add_column('social_circleuser', 'last_video',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2012, 12, 10, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CircleUser.video'
        db.delete_column('social_circleuser', 'video')

        # Deleting field 'CircleUser.last_video'
        db.delete_column('social_circleuser', 'last_video')
    ...
    models = {
        ...
        'social.circleuser': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_video': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"}),
