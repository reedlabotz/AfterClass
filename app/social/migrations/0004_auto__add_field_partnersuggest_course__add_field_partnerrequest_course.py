...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PartnerSuggest.course'
        db.add_column('social_partnersuggest', 'course',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='+', to=orm['social.Course']),
                      keep_default=False)

        # Adding field 'PartnerRequest.course'
        db.add_column('social_partnerrequest', 'course',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='+', to=orm['social.Course']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PartnerSuggest.course'
        db.delete_column('social_partnersuggest', 'course_id')

        # Deleting field 'PartnerRequest.course'
        db.delete_column('social_partnerrequest', 'course_id')
