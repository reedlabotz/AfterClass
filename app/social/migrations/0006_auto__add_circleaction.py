...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CircleAction'
        db.create_table('social_circleaction', (
        ...
        db.send_create_signal('social', ['CircleAction'])


    def backwards(self, orm):
        # Deleting model 'CircleAction'
        db.delete_table('social_circleaction')
